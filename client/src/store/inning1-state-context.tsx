...
const Inning1StateContext = createContext({
    batsmanStats: {
        runs: 0,
        balls: 0,
        fours: 0,
...
export function Inning1StateContextProvider({children} : Props){
    ...
    return (
        <Inning1StateContext.Provider value = {context}>
            {children}
        </Inning1StateContext.Provider>
    );
}

export default Inning1StateContext;