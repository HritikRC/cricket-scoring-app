...
const Inning3StateContext = createContext({
    batsmanStats: {
        runs: 0,
        balls: 0,
        fours: 0,
...
export function Inning3StateContextProvider({children} : Props){
    ...
    return (
        <Inning3StateContext.Provider value = {context}>
            {children}
        </Inning3StateContext.Provider>
    );
}

export default Inning3StateContext;